...
export class MenuButton {
  ...
  private isActiveAndFocused(): boolean {
  ...
  private handleClick = (e: Event): void => {
    ...
    this.handleMenuButtonClick.emit({
      label: this.label,
      hasSubMenu: this.submenuTriggerFor !== undefined,
    });
  };
    ...
    return (
      <Host
        class={{
          ...
          ["active-and-focused"]: this.isActiveAndFocused(),
        }}
        aria-disabled={this.disabled ? true : false}
      >
        <li role={this.variant === "toggle" ? "menuitemcheckbox" : "menuitem"}>
          <ic-button
            disableTooltip
            fullWidth
            disabled={this.disabled}
