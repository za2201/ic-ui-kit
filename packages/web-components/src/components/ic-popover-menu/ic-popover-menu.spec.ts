...
describe("ic-popover-menu", () => {
  it("should render with anchor", async () => {
    const page = await newSpecPage({
      components: [PopoverMenu, MenuButton],
      html: `<ic-button id="anchorEl"></ic-button><ic-popover-menu anchor="anchorEl" menu-aria-label="popover-menu"><ic-menu-button label="Button 1"></ic-menu-button></ic-popover-menu>`,
    });
  ...
  it("should render a menu button and menu group", async () => {
    const page = await newSpecPage({
      components: [PopoverMenu, MenuButton, MenuGroup],
      html: `<ic-button id="anchorEl"></ic-button>
      <ic-popover-menu anchor="#anchorEl" menu-aria-label="popover-menu">
      <ic-menu-button label="Button 1"></ic-menu-button>
      <ic-menu-group label="Button group">
      <ic-menu-button label="Group button 1"></ic-menu-button>
      <ic-menu-button label="Group button 2"></ic-menu-button>
      </ic-menu-group>
      </ic-popover-menu>
      `,
    });
    ...
    expect(page.root).toMatchSnapshot(
      "should render a menu button and menu group"
    );
  });
  ...
  it("should render a back button when submenu-id is set", async () => {
    const page = await newSpecPage({
      components: [PopoverMenu, MenuButton],
      html: `<ic-button id="anchorEl"></ic-button>
      <ic-popover-menu anchor="#anchorEl" menu-aria-label="popover-menu" submenu-id="submenu">
      <ic-menu-button label="Button 1"></ic-menu-button>
      <ic-menu-button label="Button 2"></ic-menu-button>
      </ic-popover-menu>`,
    });
  ...
  it("should set openingFromParent to true when openFromParent method is called", async () => {
    const page = await newSpecPage({
      ...
      html: `<ic-button id="anchorEl"></ic-button>
      <ic-popover-menu anchor="#anchorEl" menu-aria-label="popover-menu">
      <ic-menu-button label="Button 1" submenu-trigger-for="submenu" id="trigger-button"></ic-menu-button>
      <ic-menu-button label="Button 2"></ic-menu-button>
      </ic-popover-menu>
      <ic-popover-menu submenu-id="submenu" menu-aria-label="popover-menu-submenu">
      <ic-menu-button label="Button 1"></ic-menu-button>
      <ic-menu-button label="Button 2"></ic-menu-button>
      </ic-popover-menu>`,
    });
  ...
  it("should add focusable menu buttons to the list of focusable elements", async () => {
    const page = await newSpecPage({
      components: [PopoverMenu, MenuButton],
      html: `<ic-button id="anchorEl"></ic-button>
      <ic-popover-menu anchor="#anchorEl" menu-aria-label="popover-menu">
    ...
    const menuButtons = page.root.querySelectorAll("ic-menu-button");

    await page.rootInstance.addMenuButtons(menuButtons);
    await page.waitForChanges();

    expect(page.rootInstance.popoverMenuEls).toEqual(menuButtons);
  });
  ...
  it("should get the next item to select as last item if next item < 0 and select first item if next item > items length", async () => {
    const page = await newSpecPage({
      ...
      <ic-menu-button label="Button 1"></ic-menu-button>
      <ic-menu-button label="Button 2"></ic-menu-button>
      <ic-menu-button label="Button 3"></ic-menu-button>
      </ic-popover-menu>`,
    });
  ...
  it("should console error if an anchor can't be found", async () => {
    ...
    const page = await newSpecPage({
      components: [PopoverMenu, MenuButton],
      html: `<ic-button id="anchorEl"></ic-button><ic-popover-menu anchor="wrongAnchor" menu-aria-label="popover-menu"><ic-menu-button label="Button 1"></ic-menu-button></ic-popover-menu>`,
    });
    await page.waitForChanges();
  ...
  it("should console error if no anchor is specified for an original popover menu", async () => {
    ...
    const page = await newSpecPage({
      components: [PopoverMenu, MenuButton],
      html: `<ic-button id="anchorEl"></ic-button><ic-popover-menu menu-aria-label="popover-menu"><ic-menu-button label="Button 1"></ic-menu-button></ic-popover-menu>`,
    });
    await page.waitForChanges();
  ...
  it("should set the current popover's open prop to false when submenu is triggered", async () => {
    const page = await newSpecPage({
      components: [PopoverMenu, MenuButton],
      html: `<ic-button id="anchorEl"></ic-button>
      <ic-popover-menu anchor="#anchorEl" menu-aria-label="popover-menu" id="initial-popover">
      <ic-menu-button label="Button 1" submenu-trigger-for="submenu" id="trigger-button"></ic-menu-button>
      <ic-menu-button label="Button 2"></ic-menu-button>
      </ic-popover-menu>
      <ic-popover-menu submenu-id="submenu" menu-aria-label="popover-menu-submenu">
  ...
  it("should close menu when an element that isn't in the popover is clicked", async () => {
    const page = await newSpecPage({
      components: [PopoverMenu, MenuButton],
      html: `<ic-button id="anchorEl"></ic-button>
      <ic-popover-menu anchor="#anchorEl" menu-aria-label="popover-menu" id="initial-popover" open="true">
      <ic-menu-button label="Button 1" submenu-trigger-for="submenu" id="trigger-button"></ic-menu-button>
      <ic-menu-button label="Button 2"></ic-menu-button>
      </ic-popover-menu>
      <ic-popover-menu submenu-id="submenu" menu-aria-label="popover-menu-submenu">
  ...
  it("should set open to false when menu is closed", async () => {
    const page = await newSpecPage({
      components: [PopoverMenu, MenuButton],
      html: `<ic-button id="anchorEl"></ic-button>
      <ic-popover-menu anchor="#anchorEl" menu-aria-label="popover-menu" open="true">
      <ic-menu-button label="Button 1"></ic-menu-button>
      <ic-menu-button label="Button 2"></ic-menu-button>
      </ic-popover-menu>`,
    });
